...
public class ExampleUCT extends AI
{
	...
	private static int totalNodeVisits = 0; // Tracks total node visits
	/** Our player index */
	...
	public ExampleUCT()
	{
		this.friendlyName = "Example UCTlel";
	}
	...
	)
	{
		...
		SearchStatistics.recordSearch("UCT", totalNodeVisits, totalNodeCount, searchTime);
	...
	public static Node select(final Node current)
	{
        ...
        final double twoParentLog = 0.36 * Math.log(Math.max(1, current.visitCount));
        int numBestFound = 0;
...
//			System.out.println("sj: " + bestVisitCount);
